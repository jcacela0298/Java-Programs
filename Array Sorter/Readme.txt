...
I built a program that can ask the user for 3 to 10 numbers and then sort the numbers from low to high in the form of an array.

To use this program, open the .Java file in your favorite IDE for Java (I use Eclipse). Please ensure that the name of the package at the top of the file corresponds to the name of the project's package that the file is in. Then, run the arraySort file and it will prompt you to enter the amount of number you wish to sort between 3 and 10, and then it will ask for the corresponding numbers. 
